...
\subsection{Using flowcharts as device intermediate representation} \label{flowchart-attempt}
...
\subsection{C model} \label{c-model}
% Problem: we don't want to reason with the stack

One to one translation of the formal model has been realized in C. 
...
\subsubsection{Visualizing the CFG} \label{visualizing-cfg}
