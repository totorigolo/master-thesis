...
\textbf{TODO}: Use this section to explain the time limits that have made it impossible to perform certain experiments.
...
% TODO: Explain why "EVAL ``bir_eval_exp exp``" doesn't work
...
\chapter{User experience and good practices} \label{appendix_user-friendliness}
\vspace{-1cm}
\textit{}
...
In this work, we took the role of user of the HolBA platform, and of HOL4 by necessity. HOL4 learning curve is quite steep, and very few effort has been invested towards beginner friendliness, because this topic can become really time consuming and its perceived importance greatly depend on one's experience. Throughout the our design and implementation process, great care have been put into having a good user experience while keeping time spent on this issue reasonably low. Section \ref{towards-user-exp} will briefly present what have been done in order to increase user experience.
...
A logging library, called \textit{logLib}, has been implemented.
